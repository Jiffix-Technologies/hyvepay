        ...
        <div className="mb-20 mt-24">
            ...
            {/* <h5 className="heading-five font-montserrat">Settings</h5> */}
                ...
                <div className="flex md:flex-row mt-3 md:mt-0 gap-4">
                    <button onClick={() => setView(0)} className={view == 0 ? "btn btn-primary" : "btn btn-secondary"}>
                        Hyvepay
                    </button>

                    <button onClick={() => setView(1)} className={view == 1 ? "btn btn-primary" : "btn btn-secondary"}>
                        Account Settings
                    </button>

                    <button onClick={() => setView(2)} className={view == 2 ? "btn btn-primary" : "btn btn-secondary"}>
                        User & Role Managment
                    </button>

                    <button onClick={() => setView(3)} className={view == 3 ? "btn btn-primary" : "btn btn-secondary"}>
                        Preferences
                    </button>
            ...
            <div>
                {
                            ...
                            <div className="mt-4 ">
                                <div className="flex  rounded-none gap-4 w-full">
                                    <div className='w-full'>
                                        <label htmlFor="">HyvePay Pin</label><br />
                                        <input type="text" className='w-full bg-gray-100 border-none' placeholder='Enter a pin for your HyvePay account' />
                                        <br /><small>Your pin must be minimum of 4 digits</small>
                                    </div>

                                    <div className='w-full'>
                                        <label htmlFor="">Confirm HyvePay Pin</label><br />
                                        <input className='w-full bg-gray-100 border-none' type="text" placeholder='Enter a pin for your HyvePay account' />
                                        <br /><small>Your pin must be minimum of 4 digits</small>
                                    </div>
                                </div>
                                <div className='w-full mt-8'>
                                        <label htmlFor="">AutoHyve Account Password</label><br />
                                        <input className='w-[50%] bg-gray-100 border-none' type="text" placeholder='Enter your AutoHyve account password' />
                                        <br /><small>Your pin must be minimum of 4 digits</small>
                                    </div>
                    ...
                    <div className='p-14 hyvepay-setting rounded-3xl'>
                        ...
                        <div className="flex mt-10 justify-between items-center">
                            ...
                            <p>Kindly upload/update your business logo if you have one</p>
                            </div>
                        ...
                        <div className="flex gap-4 w-full">
                            <div className='w-full'>
                                <label htmlFor="">Company Full Name</label><br />
                                <input type="text" className='w-full bg-gray-100 border-none' placeholder='Company Name' />
                                {/* <br /><small>Your pin must be minimum of 4 digits</small> */}
                            </div>

                            <div className='w-full'>
                                <label htmlFor="">Name of Director</label><br />
                        ...
                        <div className="flex mt-8 gap-4 w-full">
                            <div className='w-full'>
                                <label htmlFor="">Business Category</label><br />
                                <select name="" id="" className='bg-gray-100 none w-full sm border-none'>
                            ...
                            <div className='w-full'>
                                <label htmlFor="">Business Registration Status</label><br />
                                {/* <input className='w-full bg-gray-100 border-none' type="text" placeholder='Director Name' /> */}
                                <select name="" id="" className='bg-gray-100 none w-full sm border-none'>
                                    <option value="">Choose business registration status</option>
                                </select>
                                {/* <br /><small>Your pin must be minimum of 4 digits</small> */}
                            </div>
                        </div>
                        ...
                        <div className="flex mt-8 gap-4 w-full">
                            <div className='w-full'>
                                <label htmlFor="">Workshop Address</label><br />
                                <input type="text" className='w-full bg-gray-100 border-none' placeholder='Full Address' />
                                {/* <br /><small>Your pin must be minimum of 4 digits</small> */}
                            </div>
                        ...
                        <div className="flex mt-8 gap-4 w-full">
                            ...
                            <div className='w-full'>
                                <label htmlFor="">Tax Identity Number (TIN)</label><br />
                                {/* <input className='w-full bg-gray-100 border-none' type="text" placeholder='Director Name' /> */}
                                <select name="" id="" className='bg-gray-100 none w-full sm border-none'>
                        ...
                        <div className="flex mt-8 gap-4 w-full">
                            <div className='w-full'>
                                <label htmlFor="">Name of Manager</label><br />
                                <input type="text" className='w-full bg-gray-100 border-none' placeholder='Manager Name' />
                                {/* <br /><small>Your pin must be minimum of 4 digits</small> */}
                            </div>

                            <div className='w-full'>
                                <label htmlFor="">CAC Number</label><br />
                                {/* <input className='w-full bg-gray-100 border-none' type="text" placeholder='Director Name' /> */}
                                <select name="" id="" className='bg-gray-100 none w-full sm border-none'>
                    ...
                    <div className='p-14 hyvepay-setting rounded-3xl mt-14'>
                            ...
                            <div className="flex mt-8 gap-4 w-full">
                                ...
                                <div className='w-full'>
                                    <label htmlFor="">Total Staffs</label><br />
                                    {/* <input className='w-full bg-gray-100 border-none' type="text" placeholder='Director Name' /> */}
                                    <input type="text" className='w-full bg-gray-100 border-none' placeholder='Enter the Total Staffs' />
                                    {/* <br /><small>Your pin must be minimum of 4 digits</small> */}
                                </div>

                                <div className='w-full'>
                                    <label htmlFor="">Total Technicians</label><br />
                                    <input className='w-full bg-gray-100 border-none' type="text" placeholder='Enter Total Techicans' />
                                    {/* <br /><small>Your pin must be minimum of 4 digits</small> */}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='p-14 hyvepay-setting rounded-3xl mt-14'>
                            ...
                            <div className="flex mt-8 mb-4 gap-4 w-full items-end">
                                ...
                                <div className='w-full'>
                                    <label htmlFor="">Model Year</label><br />
                                    {/* <input className='w-full bg-gray-100 border-none' type="text" placeholder='Director Name' /> */}
                                    <input type="text" className='w-full bg-gray-100 border-none' placeholder='From' />
                                    {/* <br /><small>Your pin must be minimum of 4 digits</small> */}
                                </div>

                                <div className='w-full'>
                                    {/* <label htmlFor="">Total Technicians</label><br /> */}
                                    <input className='w-full bg-gray-100 border-none' type="text" placeholder='To' />
                                    {/* <br /><small>Your pin must be minimum of 4 digits</small> */}
                                </div>
                            ...
                            <Link to="/" className='primary-color'>Add New Brand</Link>
                        </div>
                    </>)
                    : view == 2 ? (<>
                        <div className='py-14 border-none rounded-3xl'>
                        <h5 className="heading-five block mb-4">
                                Roles
                            </h5>
                            <div className="flex items-center justify-between">
                                <select name="" id="" className='btn btn-secondary sm border-1'>
                            ...
                            <table border={1} style={{ borderRadius: 20, overflow: "clip" }}>
                                ...
                                <tr>
                                    ...
                                    <td className="font-montserrat">delete_expense,view_analytics,read_customer</td>
